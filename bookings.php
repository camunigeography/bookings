	...
	public function databaseStructure ()
	{
		return "
			...
			CREATE TABLE IF NOT EXISTS `bookings` (
			  ...
			  `place` varchar(255) NOT NULL COMMENT 'Place',
		...
		--	  `visitType` enum('Museum visit','Museum workshop','Museum tour','Museum outreach') NOT NULL COMMENT 'Visit type',
		--	  `visitTypeOther` varchar(255) DEFAULT NULL COMMENT '(Specific details)',
		--	  `institutionType` enum('','School','Language school','Further Education (sixth form)','Higher Education (degree-level)','Other') NOT NULL COMMENT 'Type of institution',
			  `bookingFor` varchar(255) NOT NULL COMMENT 'Name of group or school',
		--	  `name` varchar(255) NOT NULL COMMENT 'Name of organiser',
		--	  `address` text NOT NULL COMMENT 'Address',
		--	  `postcode` varchar(9) NOT NULL COMMENT 'Postcode',
		...
		--	  `comments` text COMMENT 'Any other information/comments/requests',
			  `approved` enum('Unreviewed','Approved','Rejected','Cancelled','No-show') NOT NULL DEFAULT 'Unreviewed' COMMENT 'Approved?',
		--	  `internalVisitContent` set('Some package','Another work package','Third option','Other') DEFAULT NULL COMMENT 'Visit content',
		...
		--	  `internalPhoneCallLog` text COMMENT 'Phone call log',
			...
			) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Table of requests';
			...
			CREATE TABLE IF NOT EXISTS `settings` (
			  ...
			  `weekdays` set('Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday') DEFAULT NULL COMMENT 'Show which days?',
			  `places` text NOT NULL COMMENT 'Place title URL monikers',
			  `placeLabels` text NOT NULL COMMENT 'Place labels',
